...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'username', 'email', 'password', 'first_name', 'last_name', 'plan', 'referred_by', 'affiliate_id', 'order_count', 'flash_sale_user', 'paid'
    ];
    ...
    public function scopeEmptyTransactions($query)
    {
