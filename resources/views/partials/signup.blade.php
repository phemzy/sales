<div class="g-bg-color--sky-light" id="register">
    <div class="container g-padding-y-80--xs g-padding-y-125--xsm">
        <div class="g-text-center--xs g-margin-b-80--xs">
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Registration</p>
            <h2 class="g-font-size-32--xs g-font-size-36--md">Choose your Plan</h2>
        </div>
            ...
            <div class="col-md-4 g-margin-b-10--xs g-margin-b-0--lg">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                    <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                        ...
                        <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">BASIC</h3>
                        <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Access to the Trade Fair</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Preorder one (1) item.</li>
                        </ul>
            ...
            <div class="col-md-4 g-margin-b-10--xs g-margin-b-0--lg">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                    <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                        ...
                        <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">ABSOLUTE</h3>
                        <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Access to the Trade Fair</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Private Referral link</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Free vouchers from referrals</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Preorder two (2) items</li>
                        </ul>
                        <div class="g-margin-b-40--xs">
                            <span class="s-plan-v1__price-mark">&#8358;</span>
            ...
            <div class="col-md-4">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                    <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                        ...
                        <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">PREMIUM</h3>
                        <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Access to the Trade Fair</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Private Referral link</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Free vouchers from referrals</li>
                            <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Preorder three (3) items.</li>
                        </ul>
                        <div class="g-margin-b-40--xs">
                            <span class="s-plan-v1__price-mark">&#8358;</span>
